...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function addCart() {
        checkComplete = function(msg,data){
            if(msg == "true")
            {
                window.location = "IsBuyCTloves.aspx?type=addcart&pid="+data.pid+"&did="+data.diamondId+"&handsize="+data.handsize+"&font="+data.font+"&price="+CurrentPrice+"&material="+data.caizhi;
            }
            else
            {
                w.Show(msg);
    ...
    function toBuy()
    {
        ...
        checkComplete = function(msg,data){
            if(msg == "true")
            {
                window.location = "IsBuyCTloves.aspx?pid="+data.pid+"&did="+data.diamondId+"&handsize="+data.handsize+"&font="+data.font+"&price="+CurrentPrice+"&material="+data.caizhi;
            }
            else
            {
                w.Show(msg);
