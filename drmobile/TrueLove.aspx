			...
			<div class="love_zs txxy_bk">
				<div class="lovezs_all">
					<div class="lovezs_all-top">
						<img src="mimages/ct_cp/b_Top.jpg" />
					</div>
					<!--中间内容-->
					<div class="lovezs_all-center">
						...
						<div class="lovezs_all-word">
							<h3>真爱协议</h3>
							<p>CTloves 真爱戒指男士凭身份证一生仅可定制一枚，  <br/>
						
							作为一生唯一真爱的最高承诺。<br/>
							签署该协议则表示，您已经过慎重考虑，<br/>
							决定将一生唯一一枚的CTloves赠送给您唯一的爱人，<br/>
							将您的身份证号与CTloves编码绑定，<br/>
							并接受亲友对购买信息的验证查询。<br/>
							此定制和赠送信息将终身保存在CTloves 数据库中，<br/>
							可以查询，无法更改和删除。<br/>
							请用心呵护您的真爱！</p>
						</div>
						<!--文字部分end-->
					...
					<!--中间内容end-->
					<div class="lovezs_all-top">
						<img src="mimages/ct_cp/b_bot.jpg" />
					</div>
				</div>
			</div>
			<!--真爱协议end-->
