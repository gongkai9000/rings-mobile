...
<div class="dl_corent">
    ...
    <div class="border" id="protocol" runat="server">
    	<div class="contract">
            ...
            <div class="to_love">
                <p>Darry Ring 每位男士凭身份证号一生仅可购买一枚，作为一生唯一真爱的最高承诺。</p>
                <p>签署该协议则表示您已经过慎重考虑，决定自购买之日起，将您的身份证号与Darry Ring 编码绑定，并接受亲友对购买信息的验证查询。</p>
                <p>此购买信息将终身留存在Darry Ring 数据库中并无法更改。</p>
                <p>请用心呵护您的真爱。</p>
            </div>
