<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site.Master" AutoEventWireup="true"
    CodeBehind="manr_list.aspx.cs" Inherits="drmobile.manr_list" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   
    <title>男戒系列-Darry Ring-求婚钻戒领导品牌-戴瑞珠宝官网</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--返回选项-->
    <div class="fhx">
        <a href="javascript:history.go(-1)">返回</a> <span>男戒系列</span>
    </div>
    <!--banner-->
    <div class="banner">
        <img src="images/manring.jpg" />
    </div>
    <!--产品列表-->
    <div class="all_bk">
        <ul class="all_thing">
            <asp:Repeater ID="rp_product" runat="server">
                <ItemTemplate>
                    <li>
                        <div class="thing_top">
                            <a href="jewellery_detail.aspx?type=manr&&id=<%#Eval("ProductId") %>">
