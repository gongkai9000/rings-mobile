<%@ Page Title="" Language="C#" MasterPageFile="~/master/mSite.Master" AutoEventWireup="true"
    CodeBehind="phonics_list.aspx.cs" Inherits="drmobile.phonics_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--购买资格查询-->
    <div class="zg_search">
        <img alt="爱的礼物-项链" src="mimages/dr_cp/dj_banner.jpg" />
        <div class="searchit">
    ...
    <div class="whrite-cort djwhrite-cort fix">
        <a href="/phonics_list.aspx" class="<%=GetClass(0)%>">全部</> <a href="/phonics_list.aspx?type=3"
            class="<%=GetClass(3) %>">对戒</a> <a href="/phonics_list.aspx?type=2 " class="<%=GetClass(2)%>">
                男戒</a> <a href="/phonics_list.aspx?type=4" class="<%=GetClass(4)%>">吊坠</a> <a href="/phonics_list.aspx?type=5"
