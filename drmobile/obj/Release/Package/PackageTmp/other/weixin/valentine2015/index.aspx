...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>嫁给我！一生与你相伴-Darry Ring 真爱钻戒</title>
...
<div id="ticket_wrap">
	...
	<div id="animwrap"  class="">
		<div id="audio" onclick="musicplay(this)">
			<audio src="http://resource.darryring.com/video/ILoveYouTooMuch.mp3" autoplay="autoplay" loop="loop" data-src="media/baidu.mp3" id="music"></audio>
		</div>
		...
		<div class="anim-swip hide anim1">
			...
			<div class="index-video">
				...
				<video id="drvideo">
				  <source src="http://resource.darryring.com/video/m2.webm" type="video/webm" />
				  <source src="http://resource.darryring.com/video/m2.mp4" type="video/mp4" />
				  您的设备不支持HTML5 Video.
				</video>
			</div>
		</div>	
...
<script type="text/javascript">
    ...
    var msgDesc = "Darry Ring真爱钻戒，男士一生仅能定制一枚";
    var msgLink = "";
