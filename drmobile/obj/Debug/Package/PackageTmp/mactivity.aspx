...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="gray-cort">
        ...
        <div class="spwidth_608">
            <!--晒粉钻-->
            <div class="show_fz">
                <a href="http://www.ctloves.com/goodman/gm.html">
                    <img src="/mimages/ct_ative/pink_it.jpg" />
                </a>
            </div>
            <!--晒粉钻end-->
            <!--明星左右滑动-->
                ...
                <div class="bd">
                    <ul>
                        <li><a class="pic" href="/mstartdetail.aspx?id=2670">
                            <img alt="CTloves见证：戚薇&李承铉真爱" src="mimages/hd1.jpg" /></a>
                            <div class="cort_word spcort_word">
                                <h3>
                                    戚薇&李承铉</h3>
                                <div class="theword">
                                    <p>
                                        李承铉大胆表白CTloves式爱情的一生唯一真爱承诺</p>
                                    <p>
                                        CTloves见证：戚薇&李承铉真爱
                                    </p>
                                </div>
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=348">查看明星同款钻戒</a>
                                </div>
                            </div>
                        </li>
                        <li><a class="pic" href="/mstartdetail.aspx?id=2675">
                            ...
                            <div class="cort_word spcort_word">
                                ...
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=370">查看明星同款钻戒</a>
                                </div>
                            </div>
                        </li>
                        <li><a class="pic" href="/mstartdetail.aspx?id=2676">
                            ...
                            <div class="cort_word spcort_word">
                                ...
                                <div class="theword">
                                    <p>
                                        奢侈是精神上的唯一，是真爱的唯一。CTloves与小时代也开启了奢侈新定义......
                                    </p>
                                </div>
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=370">查看明星同款钻戒</a>
                        ...
                        <li><a class="pic" href="/mstartdetail.aspx?id=2674">
                            ...
                            <div class="cort_word spcort_word">
                                ...
                                <div class="theword">
                                    <p>
                                    “一生”的约定，“唯一”的爱人，“真爱”的信仰，这就是CTloves式爱情......</p>
                                </div>
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=140">查看明星同款钻戒</a>
                                </div>
                            </div>
                        </li>
                        <li><a class="pic" href="/mstartdetail.aspx?id=3175">
                            <img alt="杜海涛晒CTloves" src="/mimages/hd2.jpg" /></a>
                            <div class="cort_word">
                                <h3>
                                    杜海涛</h3>
                                <div class="theword">
                                    <p>
                                    杜海涛晒CTloves感慨父母感情好，宣布加入CTloves族</p>
                                </div>
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=379">查看明星同款钻戒</a>
                                </div>
                            </div>
                        </li>
                        <li><a class="pic" href="/mstartdetail.aspx?id=3176">
                            <img alt="陈一冰公开CTloves族身份" src="/mimages/hd3.jpg" /></a>
                            <div class="cort_word">
                                <h3>
                                    陈一冰</h3>
                                <div class="theword">
                                    <p>
                                    陈一冰公开CTloves族身份，表白爱妻“任性爱一辈子</p>
                                </div>
                                <div class="more_cp star_samecp">
                                    <a href="/ctring_detail.aspx?id=323">查看明星同款钻戒</a>
                                </div>
                            </div>
                        </li>
                    </ul>
