...
namespace DRM.Entity
{
    ...
    public partial class ProductImgUrl: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        private void FixupProduct(Product previousValue)
        {
            ...
            if (previousValue != null && previousValue.ProductImgUrl.Contains(this))
            {
                previousValue.ProductImgUrl.Remove(this);
            }
    
            if (Product != null)
            {
                if (!Product.ProductImgUrl.Contains(this))
                {
                    Product.ProductImgUrl.Add(this);
                }
