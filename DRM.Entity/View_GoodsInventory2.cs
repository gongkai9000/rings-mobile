...
namespace DRM.Entity
{
    ...
    public partial class View_GoodsInventory2: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string goodsType
        {
            ...
            set
            {
                if (_goodsType != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("属性“goodsType”是对象键的一部分，不可更改。仅当未跟踪对象或对象处于“已添加”状态时，才能对键属性进行更改。");
                    }
                    _goodsType = value;
