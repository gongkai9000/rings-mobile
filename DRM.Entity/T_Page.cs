...
namespace DRM.Entity
{
    ...
    public partial class T_Page: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public int pageid
        {
            ...
            set
            {
                if (_pageid != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("属性“pageid”是对象键的一部分，不可更改。仅当未跟踪对象或对象处于“已添加”状态时，才能对键属性进行更改。");
                    }
                    _pageid = value;
