...
namespace DRM.Entity
{
    ...
    public partial class view_admentInfo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string adTitle
        {
            ...
            set
            {
                if (_adTitle != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("属性“adTitle”是对象键的一部分，不可更改。仅当未跟踪对象或对象处于“已添加”状态时，才能对键属性进行更改。");
                    }
                    _adTitle = value;
        ...
        public int imgId
        {
            ...
            set
            {
                if (_imgId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("属性“imgId”是对象键的一部分，不可更改。仅当未跟踪对象或对象处于“已添加”状态时，才能对键属性进行更改。");
                    }
                    _imgId = value;
                    OnPropertyChanged("imgId");
                }
            }
        }
        private int _imgId;
