...
namespace DRM.Entity
{
    ...
    public partial class view_product_dprice: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        [DataMember]
        public Nullable<decimal> ZDiamondPrice
        {
            get { return _zDiamondPrice; }
            set
            {
                if (_zDiamondPrice != value)
                {
                    _zDiamondPrice = value;
                    OnPropertyChanged("ZDiamondPrice");
                }
            }
        }
        private Nullable<decimal> _zDiamondPrice;
